...
export default function Pte() {
  const otherClasses = classServices.filter((item) => item.id !== "cls-pte");
        ...
        <div className="relative  sm:h-80 md:h-105 h-screen min-h-svh overflow-hidden">
          ...
          <div className="absolute right-6 md:left-10 top-20 md:top-15 max-w-xl rounded-2xl backdrop-blur-xs p-6 md:p-8">
            ...
            <p className="mt-4 text-left text-base md:text-lg leading-relaxed text-black">
              Everest Global Network offers focused, result‑oriented PTE classes
              to help you achieve your target band. We cover Listening, Reading,
              Writing, and Speaking with clear strategies, regular practice, and
              detailed feedback from experienced instructors following the
              latest exam patterns. Benefit from mock tests, time‑management
              techniques, and personalized guidance to strengthen weak areas and
              build confidence.
            </p>
          </div>
        </div>
        ...
        <div className=" bg-linear-to-br from-gray-50 to-white p-6 md:p-10 ">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="relative h-56 sm:h-64 rounded-2xl border bg-white p-5 shadow-xl shadow-secondary">
              ...
              <p className="mt-1 text-sm text-gray-700">Score: &gt;= 65</p>
            ...
            <div className="relative h-56 sm:h-64 rounded-2xl border bg-white p-5 shadow-xl shadow-secondary">
              ...
              <p className="mt-1 text-sm text-gray-700">Score: &gt;= 60</p>
              <p className="mt-4 md:mt-11 text-sm leading-relaxed text-gray-600">
            ...
            <div className="relative h-56 sm:h-64 rounded-2xl border bg-white p-5 shadow-xl shadow-secondary">
              ...
              <p className="mt-1 text-sm text-gray-700">Score: &gt;= 55</p>
              <p className="mt-4 md:mt-11 text-sm leading-relaxed text-gray-600">
                Requirements differ by university. Many programs accept 5.5–6.0
                with specific component thresholds.
              </p>
            </div>
